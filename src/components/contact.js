    ...
    <Element name="contact">
      <div className={styles.contactContainer}>
        ...
        <div className={styles.contactLinks} id="contact">
          <ContactLink
            Icon={FaLinkedinIn}
            link="https://www.linkedin.com/in/modernartist/"
            delay="400"
          />
          {/* <ContactLink
            Icon={FaBehance}
          ...
          <ContactLink
            Icon={FaDribbble}
            link="https://dribbble.com/Modern_Artist"
            delay="600"
          />
          <ContactLink
            Icon={FaGithub}
            link="https://github.com/Modern-artist"
            delay="800"
          />
          <ContactLink
            Icon={FaTwitter}
            link="https://twitter.com/Modern_a_r_t"
            delay="1000"
          />
        </div>
      </div>
